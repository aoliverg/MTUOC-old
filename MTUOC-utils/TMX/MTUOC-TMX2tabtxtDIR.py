...
if __name__ == "__main__":
    ...
    parser.add_argument('-s','--sl', nargs='+', action="store", dest="slcode", help='The codes for the source language.',required=False)
    parser.add_argument('-t','--tl', nargs='+', action="store", dest="tlcode", help='The codes for the target language.',required=False)
