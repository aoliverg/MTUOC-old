...
class Tokenizer():
    def __init__(self):
        self.specialchars=["«","»","—","‘","’","“","”","„",]
        self.subs=['lle￭-￭la', 'lle￭-￭las', 'lle￭-￭lo', 'lle￭-￭los', 'nó￭-￭las', 'nó￭-￭los', 'no￭-￭la', 'no￭-￭las', 'no￭-￭lo', 'no￭-￭los', 'vó￭-￭las', 'vó￭-￭los', 'vo￭-￭la', 'vo￭-￭las', 'vo￭-￭lo', 'vo￭-￭los']
...
def print_help():
    print("MTUOC_tokenizer_gal.py A tokenizer for Galicia, usage:")
