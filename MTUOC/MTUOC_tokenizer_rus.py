...
def print_help():
    print("MTUOC_tokenizer_rus.py A tokenizer for Russian, usage:")
    ...
    print('    cat "sentence to tokenize." | python3 MTUOC_tokenizer_rus.py detokenize')
