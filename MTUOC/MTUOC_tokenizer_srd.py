...
class Tokenizer():
    def __init__(self):
        self.specialchars=["«","»","—","‘","’","“","”","„",]
        self.subs=["d'￭","s'￭","un'￭","m'￭","t'￭","nd'￭","nch'￭","b'￭","dd'￭","l'￭","￭·bi","￭·bos","￭·dda","￭·ddas","￭·ddi","￭·ddis","￭·ddos","￭·ddu","￭·la","￭·las","￭·li","￭·lis","￭·los","￭·lu","￭·mi","￭·nche","￭·nde","￭·nos","￭·si","￭·ti"]
    ...
    def main_tokenizer(self,segment):
        #normalization
        tochange=["·bi","·bos","·dda","·ddas","·ddi","·ddis","·ddos","·ddu","·la","·las","·li","·lis","·los","·lu","·mi","·nche","·nde","·nos","·si","·ti"]
        for tch in tochange:
            tch1=tch.replace("·",".")
            segment=segment.replace(tch1,tch)
        segment=" "+segment+" "
...
def print_help():
    print("MTUOC_tokenizer_cat.py A tokenizer for Sardinian, usage:")
