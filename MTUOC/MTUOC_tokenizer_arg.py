...
class Tokenizer():
    def __init__(self):
        self.specialchars=["«","»","—","‘","’","“","”","„",]
        self.subs=["l'￭","￭'l","￭'ls","￭'s","qu'￭","d'￭","t'￭","ent'￭","m'￭","s'￭","b'￭","n'￭","￭'n","￭-se","￭-i","￭-ne","￭-lo","￭-bi","￭-los","￭-ie","￭-les","￭-les","￭-lis","￭-mi"]
...
def print_help():
    print("MTUOC_tokenizer_eng.py A tokenizer for Aragonese, usage:")
    print("Simple tokenization:")
    print('    cat "sentence to tokenize." | python3 MTUOC_tokenizer_arg.py tokenize')
    print('    python3 MTUOC_tokenizer_arg.py tokenize < file_to_tokenize > tokenized_file')
    print()
    print("Simple detokenization:")
    print('    cat "sentence to tokenize." | python3 MTUOC_tokenizer_arg.py detokenize')
    print('    python3 MTUOC_tokenizer_arg.py detokenize < file_to_detokenize > detokenized_file')
    print()
