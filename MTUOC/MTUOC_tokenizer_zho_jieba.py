#    MTUOC_tokenizer_zho_jieba
#    This is a tokenization-detokenization process for Chinese using the Jieba library.
...
fulldicname=os.path.join(current_dir,'dict.txt.big')
