...
def print_help():
    print("MTUOC_tokenizer_ita.py A tokenizer for Italian, usage:")
    print("Simple tokenization:")
    print('    cat "sentence to tokenize." | python3 MTUOC_tokenizer_ita.py tokenize')
    print('    python3 MTUOC_tokenizer_ita.py tokenize < file_to_tokenize > tokenized_file')
    print()
    print("Simple detokenization:")
    print('    cat "sentence to tokenize." | python3 MTUOC_tokenizer_ita.py detokenize')
    print('    python3 MTUOC_tokenizer_ita.py detokenize < file_to_detokenize > detokenized_file')
    print()
